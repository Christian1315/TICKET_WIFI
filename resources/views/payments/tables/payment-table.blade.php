<table id="example1" class="table table-bordered table-striped table-sm">
    ...
    <tbody class="table-body">
        ...
        <tr>
            ...
            <td class="text-center">{{number_format($payment->package_price,2,","," ")}}</td>
            ...
            <td class="text-center">
                <a target="_blank" href="{{route('invoice.download',$payment->id)}}" class="btn btn-sm bg-blue text-dark border text-white"><i class="bi bi-cloud-download"></i> &nbsp; {{ __('Télécharger') }}</a>
            </td>
        </tr>
        @endforeach
    </tbody>
